<template>
  <md-part>
    ...
    <md-part-body>
      <md-query @select="select" ref="list" md-query-id="suite.amiba.data.accounting.list"></md-query>
...
<script>
  export default {
    ...
    methods: {
      create(){
        this.$router.push({ name: 'module', params: { module: 'amiba.data.accounting.edit' }});
      },
      remove(){
        ...
        this.$http.delete('amiba/data-accountings/'+ids).then(response => {
          this.loadData();
          this.loading--;
