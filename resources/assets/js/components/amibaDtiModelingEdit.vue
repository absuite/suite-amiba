  ...
  <md-part>
    <md-part-toolbar>
      ...
      <md-part-toolbar-crumbs>
        <md-part-toolbar-crumb>数据建模</md-part-toolbar-crumb>
        <md-part-toolbar-crumb>建模</md-part-toolbar-crumb>
      </md-part-toolbar-crumbs>
    </md-part-toolbar>
    <md-part-body>
      <md-content class="flex layout-column">
        ...
        <md-field>
          <label>期间</label>
          <md-input-ref multiple md-ref-id="suite.cbo.period.account.ref" v-model="model.main.period">
          </md-input-ref>
        </md-field>
        <md-field>
          <label>备注</label>
