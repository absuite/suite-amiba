<template>
  <md-part>
    ...
    <md-part-body>
      <md-query @select="select" @dblclick="edit" ref="list" md-query-id="suite.amiba.purpose.list"></md-query>
...
<script>
  export default {
    ...
    methods: {
      create(){
        this.$router.push({ name: 'module', params: { module: 'amiba.purpose.edit' }});
      },
      edit(item){
        this.$router.push({ name: 'id', params: { module: 'amiba.purpose.edit',id:item.id }});
      },
      remove(){
