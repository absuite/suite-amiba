...
class ModelingLine extends Model {
  ...
  protected $fillable = ['id', 'ent_id', 'modeling_id', 'element_id',
    ...
    'item_category_id', 'account_code', 'trader_id', 'item_id', 'price_id',
  ...
  public function setPriceIdAttribute($value) {
    $this->attributes['price_id'] = empty($value) ? null : $value;
  }
  ...
  public function price() {
    return $this->belongsTo('Suite\Amiba\Models\Price');
  }
}
